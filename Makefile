...
all: fastq_to_table.o bwa_bam_to_mapfiles2.o bwa_mapdistance.o bwa_util.o isbinary.o rename_reference.o cluster_cnv2.o string_unsigned_lookup.o file_util.o umm_te_finder.o teclust.o filter_edit.o get_pair_ids_bwa.o
	$(CXX) $(CXXFLAGS) -o rename_reference rename_reference.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS) 
	$(CXX) $(CXXFLAGS) -o fastq_to_table fastq_to_table.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS) 
	$(CXX) $(CXXFLAGS) -o bwa_bam_to_mapfiles bwa_bam_to_mapfiles2.o bwa_util.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS) 
	$(CXX) $(CXXFLAGS) -o bwa_mapdistance bwa_mapdistance.o bwa_util.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS)  
	$(CXX) $(CXXFLAGS) -o cluster_cnv cluster_cnv2.o string_unsigned_lookup.o file_util.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS) 
	$(CXX) $(CXXFLAGS) -o umm_te_finder umm_te_finder.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS) 
	$(CXX) $(CXXFLAGS) -o teclust teclust.o isbinary.o string_unsigned_lookup.o $(LIBDIR) $(SEQ) $(BIOSTREAMS) 
	$(CXX) $(CXXFLAGS) -o filter_edit filter_edit.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS)
	$(CXX) $(CXXFLAGS) -o get_pair_ids_bwa get_pair_ids_bwa.o isbinary.o $(LIBDIR) $(SEQ) $(BIOSTREAMS)
dist: 
